...
public class ECommerceUI {
	...
	public static void main(String[] args) {
		...
		List<Product > sorted=pService.sortProductsInAscending(pList);
		
		System.out.println(" Products in sorted order of price");
		for(Product p:sorted)
		{
			System.out.println("ID="+p.getId()+" Name="+p.getName()+" price="+p.getPrice()+" description="+p.getDescription());
		}
