...
public class CountryController{
	...
	public String createNewCountry(@RequestParam("countryId") String countryId,@RequestParam("countryName") String countryName ,@RequestParam("regionId") String regionId, ModelMap model) {
